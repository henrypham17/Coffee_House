...
$('.hero-slider2').on('change.owl.carousel', function (event) { new WOW().init(); });
...
$(".plus-btn").on("click", function () {
    var i = $(this).closest(".cart-quantity").children(".quantity").get(0).value++,
        c = $(this).closest(".cart-quantity").children(".minus-btn");
    i > 0 && c.removeAttr("disabled");
}), $(".minus-btn").on("click", function () { 2 == $(this).closest(".cart-quantity").children(".quantity").get(0).value-- && $(this).attr("disabled", "disabled"); })
